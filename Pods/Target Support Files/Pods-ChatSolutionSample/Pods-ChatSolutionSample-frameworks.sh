...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/CoinliveChatUIKit/CoinliveChatUIKit.framework"
  ...
  install_framework "${PODS_XCFRAMEWORKS_BUILD_DIR}/CoinliveChatSDK/CoinliveChatSDK.framework"
fi
